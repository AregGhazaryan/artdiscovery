...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('users')->insert([
          ...
          [
            'id' => '388bd8e7-aded-4e79-8bda-f07671b1ba83',
            'first_name' => 'Անուշ',
            'last_name' => 'Հակոբյան',
            'email' => 'rubensuchyan@yandex.ru',
            'birthday' => '1981-08-02',
            'mobile' => '093640641',
            'avatar' => 'default.png',
            'address' => 'ք. Երևան, Նաիրի Զարյան 4/1',
            'password' => '$2y$10$fgGeIQHfKLB96z4NewNTXOfb0UhuTTez2dSVISBsIngIMBsJHgWPy',
            'agreed_to_terms' => 1,
            'gender' => 'female',
            'role_id' => 1,
            'status_id' => 1,
          ...
          [
            'id' => '388bd111-ad22-4e33-8b44-f07671b1ba55',
            'first_name' => 'Art',
            'last_name' => 'Discovery',
            'email' => 'info@artdiscovery.com',
            'birthday' => null,
            'mobile' => null,
            'avatar' => 'default.png',
            'address' => null,
