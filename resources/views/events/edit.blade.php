    ...
    <form action="{{ route('events.update', $event->id) }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group pt-4 row">
        <div class="col-lg-6">
          ...
          <div class="col-sm-12">
            <input type="text" class="form-control" id="title" name="title" placeholder="@lang('events.title')" value="{{ $event->title }}">
          </div>
        </div>
        <div class="col-lg-6">
          <div class="col-sm-12">
          ...
          <div class="col-sm-12">
            <input type="text" class="form-control" id="location" name="location" placeholder="@lang('events.location')" value="{{ $event->location }}">
          </div>
        </div>
      </div>
      ...
      <div class="form-group row">
        <div class="col-lg-6">
          <label for="date" class="col-sm-12 col-form-label">
            ...
            <div class="col-sm-12">
              <input type="text" class="form-control" id="start-date" name="start_date" placeholder="2019-04-28 18:00" value="{{ $event->start }}">
            </div>
        </div>
        <div class="col-lg-6">
          <label for="date" class="col-sm-12 col-form-label">
            ...
            <div class="col-sm-12">
              <input type="text" class="form-control" id="title" name="end_date" placeholder="2019-06-18 20:00" value="{{ $event->end }}">
            </div>
        </div>
      </div>
