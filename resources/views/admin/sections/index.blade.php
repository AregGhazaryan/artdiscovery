                    ...
                    <table class="table text-center">
                        <thead>
                            <tr>
                                <th scope="col">#</th>
                                <th scope="col">
                                    @lang('sections.title_hy')</th>
                                <th scope="col">
                                    @lang('sections.title_en')</th>
                                <th scope="col">
                                    @lang('sections.title_ru')</th>
                                <th scope="col">
                                    @lang('sections.color')</th>
                                <th scope="col">
                                    @lang('sections.actions')</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <a href="{{ route('sections.edit', $section->id) }}" class="btn btn-sm contain-button-sm btn-primary mr-2"><i class="fas fa-edit mr-2"></i>
                                            @lang('sections.edit')</a>
