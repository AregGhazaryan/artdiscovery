...
<div class="container shadow p-4">
  ...
  <form action="{{ route('admin.videos.update', $video->id) }}" method="post">
    ...
    <div class="row">
      ...
      <div class="form-group col">
        <label for="title-en">@lang('videoupload.title_ru')</label>
        <input type="text" name="title_ru" class="form-control" id="title-ru" value="{{ $video->title_ru }}"
          placeholder="@lang('videoupload.title_ru')">
      </div>
    </div>
    <div class="row">
      <div class="form-group col">
      ...
      <div class="form-group col">
        <label for="subsection">@lang('videoupload.subsection')</label>
    ...
    <div class="form-group">
      ...
      <input type="text" name="date" class="form-control" id="date" placeholder="@lang('videoupload.date')"
        value="{{ $video->start_date }}{{ $video->end_date ? "-".$video->end_date : '' }}">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <label for="description-ru">@lang('videoupload.description_ru')</label>
      <textarea name="description_ru" class="form-control textarea" id="description-ru"
        placeholder="@lang('videoupload.description_ru')">{{ $video->description_ru }}</textarea>
    </div>
