  ...
  <form action="{{ route('admin.videos.store') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
      <div class="form-group col">
        ...
        <input type="text" name="title_hy" class="form-control" id="title-hy"
          placeholder="@lang('videoupload.title_hy')" value="{{ old('title_hy') }}">
      </div>
      <div class="form-group col">
        <label for="title-en">
          @lang('videoupload.title_en')</label>
        <input type="text" name="title_en" class="form-control" id="title-en"
          placeholder="@lang('videoupload.title_en')" value="{{ old('title_en') }}">
      </div>
      <div class="form-group col">
        <label for="title-ru">
          @lang('videoupload.title_ru')</label>
        <input type="text" name="title_ru" class="form-control" id="title_ru-en"
          placeholder="@lang('videoupload.title_ru')" value="{{ old('title_ru') }}">
      </div>
    </div>
    <div class="row">
      <div class="form-group col">
    ...
    <div class="form-group">
      ...
      <div class="row">
        <div class="col">
          <label for="start_date">@lang('videoupload.start_date')</label>
          <input type="text" name="start_date" class="form-control" id="start_date" placeholder="1440-08-23"
            value="{{ old('start_date') }}">
        </div>
        <div class="col">
          <label for="end_date">@lang('videoupload.end_date')</label>
          <input type="text" name="end_date" class="form-control" id="end_date" placeholder="1440-08-23"
            value="{{ old('end_date') }}">
        </div>
      </div>
    </div>
    <div class="form-group">
      ...
      <textarea name="description_hy" class="form-control textarea" id="description-hy"
        placeholder="@lang('videoupload.description_hy')">{{ old('description_hy') }}</textarea>
    </div>
    <div class="form-group">
      ...
      <textarea name="description_en" class="form-control textarea" id="description-en"
        placeholder="@lang('videoupload.description_en')">{{ old('description_en') }}</textarea>
    </div>
    <div class="form-group">
      <label for="description-ru">
        @lang('videoupload.description_ru')</label>
      <textarea name="description_ru" class="form-control textarea" id="description-ru"
        placeholder="@lang('videoupload.description_ru')">{{ old('description_ru') }}</textarea>
    </div>
