<nav class="navbar navbar-expand-md navbar-light bg-white admin-nav">
    <div class="container">
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#admin-nav-collapse" aria-controls="admin-nav-collapse" aria-expanded="false" aria-label="{{ __('Toggle navigation') }}">
